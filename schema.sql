...
BEGIN
  ...
  -- 3. articles 테이블에 초안으로 삽입합니다. (recommended_article_slug 추가)
  ...
  VALUES (
    ...
    '{}', -- 빈 태그 배열
    p_suggestion_id,
    selected_suggestion.recommended_article_slug
...
ALTER TABLE ONLY "public"."dogs"
    ADD CONSTRAINT "fk_baseline_analysis" FOREIGN KEY ("baseline_analysis_id") REFERENCES "public"."joint_analysis_records"("id") ON DELETE SET NULL;
