...
const features = [
  ...
  },
  {
    ...
    title: 'AI 행동 및 심리 분석',
    description:
      '최신 AI기술로 반려견의 관절 움직임까지 감지하는 AI가 행동의 숨은 의미를 정확히 해석합니다. 강아지의 내면의 성향을 파악하고 더 깊은 유대감을 형성하세요.',
    Icon: BrainCircuit,
...
const FeatureSection = ({ feature, index }) => {
  ...
  return (
    <motion.div
      initial="hidden"
      animate="visible" // 렌더링 시 바로 애니메이션 시작
      variants={variants}
      transition={{ 
        duration: 0.8, 
        ease: "easeOut",
        delay: index * 0.3 // 각 아이템에 0.3초의 시간차를 둠
      }}
